    ...
    <>
      ...
      <main className={styles.container}>
        ...
        <article className={styles.speechContent}>
          ...
          <p>Nasrun Minallah Wa Fathun Qarib,<br /><strong>Wassalamualaikum Warahmatullahi Wabarakatuh.</strong></p>
          <p className={styles.closing}><strong>Pujiono, S.E.I.</strong><br />Kepala SMK Ahmad Dahlan Sukadamai</p>
        </article>
      </main>
